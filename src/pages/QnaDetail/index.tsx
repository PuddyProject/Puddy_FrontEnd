...
import Comment from 'components/qnaDetail/QnaComment';
...
import { questionsApi } from 'constants/apiEndpoint';
import { getPathWriteAnswer } from 'constants/routes';
...
export default function QnaDetail() {
  ...
  useEffect(() => {
    get({ endpoint: `${questionsApi.requestQuestionsId(postId)}` }).then((res) => {
